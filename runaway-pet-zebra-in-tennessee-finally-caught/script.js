...
const quizQuestions = [
  {
    ...
    "explanation": "The article states Ed was brought to a farm in Rutherford County.",
    "question": "In which county in Tennessee did Ed the zebra escape?",
    "type": "single-choice",
    "options": [
      "Davidson County",
      "Rutherford County",
  ...
  },
  {
    ...
    "explanation": "The article mentions that Ed was found on June 8th.",
    "question": "On what date was Ed the zebra finally found?",
    "type": "single-choice",
    "options": [
      "June 1",
      "June 15",
  ...
  },
  {
    ...
    "explanation": "The article states that a helicopter lifted Ed with a net to bring him home.",
    "question": "Ed was returned home via a __BLANK__.",
    "type": "cloze"
  },
  {
    "answer": [
    ...
    "explanation": "The article mentions that Ed was brought to live with alpacas, bison, and cows.",
    "question": "According to the article, which animals were already living on the farm with Ed?",
  ...
  {
    "answer": [
      "He ran away less than a day after arriving"
    ],
    "explanation": "The article mentions that Ed caused chaos after escaping from a farm just hours after arriving and was missing for a week",
    "question": "What caused chaos in the town in Tennessee?",
    "type": "single-choice",
    "options": [
      "He ran away less than a day after arriving",
      "He was seen running on highways but immediately caught",
      "He attacked local residents",
      "He was never found"
    ]
  }
];
const articleContent = "# Runaway Pet Zebra In Tennessee Finally Caught\nIn early June 2025, a zebra caused chaos in a Tennessee town after escaping from a farm just hours after arriving. The zebra, later named Ed, was missing for a week.\nEd was brought to a farm in Rutherford County to live with alpacas, bison, and cows. But less than a day after he arrived, he ran away.\nHe was seen running on highways and through neighborhoods. Police used drones to look for him, and he was finally found on June 8, grazing in a field. A helicopter lifted him with a net and brought him home safely.\nEdʼs adventure went viral online. People shared funny pictures, and he even became the star of a mural and a childrenʼs book.\nHis owners renamed him Ed, but theyʼre not sure if he can stay on the farm. They hope a zoo or sanctuary will adopt him so he stays safe and doesnʼt escape again.";
