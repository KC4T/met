...
const quizQuestions = [
  {
    ...
    "explanation": "The article states that the Rubin Observatory sits atop Cerro Pachón, a mountain in northern Chile.",
    "question": "In which country is the Rubin Observatory located?",
    "type": "single-choice",
    "options": [
      "USA",
      "Chile",
  ...
  },
  {
    ...
    "explanation": "The article mentions a '10-year project to study the sky every night'.",
    "question": "How many years will the Rubin Observatory project last?",
    "type": "single-choice",
    "options": [
      "5",
      "10",
  ...
  },
  {
    ...
    "explanation": "The passage mentions that the observatory will help scientists find new asteroids.",
    "question": "The Rubin Observatory will help scientists find new what?",
    "type": "single-choice",
    "options": [
      "planets",
      "asteroids",
  ...
  },
  {
    ...
    "explanation": "The article says Cerro Pachón is known for its clear, dark skies.",
    "question": "Cerro Pachón, where the Rubin Observatory is located, is known for its what?",
    "type": "single-choice",
    "options": [
      "tall mountains",
      "large cities",
  ...
  },
  {
    ...
    "explanation": "The article states that the observatory found 2,104 new asteroids.",
    "question": "How many new asteroids did the observatory find?",
    "type": "single-choice",
    "options": [
      "1,000",
      "2,104",
...
const articleContent = "# Rubin Observatory\n\nAstronomers and skywatchers around the world are celebrating the release of the first images from the Vera C. Rubin Observatory. This is an important step in a 10-year project to study the sky every night.\n\n\"The sky and the world aren't static,\" says the head of image processing at the observatory. \"There's asteroids flying by, stars exploding.\"\n\nThe Rubin Observatory sits atop Cerro Pachón, a mountain in northern Chile known for its clear, dark skies. Scientists from different countries helped build it. It has the world’s largest digital camera, which can take huge and clear pictures of the sky in just a few seconds.\n\nFor the next ten years, the observatory will scan the entire southern sky every night. It will help scientists find new asteroids, watch exploding stars, and learn more about dark matter and dark energy. “These images are fantastic. They're incredibly high resolution. But they are only a tiny part of all the data we have,” said researcher Kevin Reil.\n\nThe observatory also found 2,104 new asteroids, including seven near-Earth asteroids. Fortunately, none of them pose any danger to our planet.";
